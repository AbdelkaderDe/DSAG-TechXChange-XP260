...
- ✅ This behavior is regulated by the `@cap-js/audit-logging` plugin. For details on configurig the audit log plugin, see the [documentation](https://cap.cloud.sap/docs/guides/data-privacy/audit-logging).
