...
- [Step 3: Configure Users access](#step-3-configure-users-access)
     - [3.1. Import business users into SAP cloud identity](ex0#31-import-business-users-into-sap-cloud-identity)
     - [3.2. Set Initial Password For Business Users](#32-set-initial-password-for-business-users)
     - [3.3. Map IAS Users to BTP Subaccount](ex0#33-map-ias-users-to-the-btp-subaccount)
     - [3.4. Configure Role Collections](ex0#34-configure-role-collections)
     - [3.5. Configure Cloud Foundry Admin Access (Platform User)](ex0#35-configure-cloud-foundry-admin-access-platform-user)
